...
-- wBattleMode: 0=overworld, 1=wild, 2=trainer; wEnemyMonDVs for wild encounter DVs
local W_BATTLE_MODE = 0xD116
...
while true do
    ...
    -- Wait until in battle (wBattleMode != 0) and enemy DVs are populated
    local timeout = 300
    while timeout > 0 do
        emu.frameadvance()
        timeout = timeout - 1
